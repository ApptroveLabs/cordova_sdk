  ...
  private void initializeSDK(String message, CallbackContext callbackContext, String action) {
    ...
    try {
      ...
      sdkConfig.setAppSecret(
          com.trackier.cordova_sdk.TrackierCordovaUtil.getStringVal("secretId", trackiersdkConfigJson),
          com.trackier.cordova_sdk.TrackierCordovaUtil.getStringVal("secretKey", trackiersdkConfigJson));
      sdkConfig.setManualMode(
          com.trackier.cordova_sdk.TrackierCordovaUtil.getBooleanVal("manualMode", trackiersdkConfigJson));
      ...
      sdkConfig.setSDKVersion("1.6.79");

      sdkConfig.setFacebookAppId(
          com.trackier.cordova_sdk.TrackierCordovaUtil.getStringVal("facebookAppId", trackiersdkConfigJson));
      sdkConfig
          .setAndroidId(com.trackier.cordova_sdk.TrackierCordovaUtil.getStringVal("androidId", trackiersdkConfigJson));
      ...
      String encryptionKey = com.trackier.cordova_sdk.TrackierCordovaUtil.getStringVal("encryptionKey",
          trackiersdkConfigJson);
      if (encryptionKey != null && !encryptionKey.isEmpty()) {
        sdkConfig.setEncryptionKey(encryptionKey);
      }

      String encryptionType = com.trackier.cordova_sdk.TrackierCordovaUtil.getStringVal("encryptionType",
          trackiersdkConfigJson);
