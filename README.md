...
- Login to your AppTrove account.
...
AppTrove SDK need the following below permission in the AndroidManifest.xml
...
```js
import { Component } from '@angular/core';
import { AppTroveCordovaPlugin, AppTroveConfig, AppTroveEvent, AppTroveEnvironment } from '@awesome-cordova-plugins/apptrove/ngx';
