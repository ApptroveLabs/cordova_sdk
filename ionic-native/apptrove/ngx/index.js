...
var AppTroveDeepLink = /** @class */ (function () {
    function AppTroveDeepLink(map) {
        this.url = map.url;
    ...
    return AppTroveDeepLink;
}());
export { AppTroveDeepLink };
var AppTroveCordovaPlugin = /** @class */ (function (_super) {
    ...
    AppTroveCordovaPlugin.prototype.setUserAdditionalDetails = function (details) { return cordova(this, "setUserAdditionalDetails", {}, arguments); };
    ...
    AppTroveCordovaPlugin.prototype.updatePostbackConversion = function (conversionValue, coarseValue, lockWindow) { return cordova(this, "updatePostbackConversion", {}, arguments); };
